...
CREATE TABLE `komik` (
  ...
  `penulis` varchar(265) NOT NULL,
  `penerbit` varchar(265) NOT NULL,
  `sampul` varchar(265) NOT NULL,
...
(1, '2017-11-20-223112', 'Myth\\Auth\\Database\\Migrations\\CreateAuthTables', 'default', 'Myth\\Auth', 1604330171, 1);
